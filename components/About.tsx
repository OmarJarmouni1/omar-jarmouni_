    ...
    >
      <div className="flex flex-col  justify-around flex-wrap items-center   max-w-[900px]">
        ...
        <p className="text-gray-300 text-center ">
          ...
          between logic and creativity. My expertise centers around Softwar Engeneering, where I seamlessly
          ...
          translating concepts into Technology, creating seamless user experiences,
